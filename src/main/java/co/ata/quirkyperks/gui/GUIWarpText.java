...
public class GUIWarpText extends Gui
{
    ...
    public GUIWarpText(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height)
    {
        this.id = componentId;
     ...
     * Draws the textbox
     */
    public void drawTextBox(int col)
    {
        if (this.getVisible())
        {
            ...
            if (!s.isEmpty())
            {
                ...
                j1 = this.fontRenderer.drawStringWithShadow(s1, (float)l, (float)i1, col);
            }
            ...
            {
                j1 = this.fontRenderer.drawStringWithShadow(s.substring(j), (float)j1, (float)i1, col);
            }
            ...
            if (flag1)
            {
                ...
                {
                    this.fontRenderer.drawStringWithShadow("_", (float)k1, (float)i1, col);
                }
            }
